...
function inherict(){
    ...
    class Konsultasi extends Umur{
        ...
        status(){
            ...
            if(this.hitungUmur()>=17 && this.hitungUmur()<30 && this.bmi =='Obesitas'){
                document.getElementById('pusKon').innerHTML = 'Anda bisa mendapatkan Konsultasi gratis'
                document.getElementById('pusBat').innerHTML ='tidak dapat obat gratis'
            }else if(this.hitungUmur()>=30 && this.bmi =='Obesitas'){
                document.getElementById('pusBat').innerHTML = 'Anda bisa mendapatkan Obat gratis'
                document.getElementById('pusKon').innerHTML = 'Anda bisa mendapatkan Konsultasi gratis'
            }else{
                document.getElementById('pusKon').innerHTML = 'Maaf anda sudah sehat'
            }
